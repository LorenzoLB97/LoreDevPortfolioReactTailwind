            ...
            <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
                ...
                <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                    <iframe
                        ...
                        src="https://www.google.com/maps/embed/v1/place?q=bellinzona&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
                    />
                    ...
                    <div className="bg-gray-900 relative flex flex-wrap py-6 pr-6 rounded shadow-md">
                        <div className="lg:w-1/2 px-6">
                            ...
                            <p className="mt-1 text-malibu-500">
                                Bellinzona
                            </p>
                        </div>
                        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                            <h2 className="title-font font-semibold text-white tracking-widest text-xs ml-[-40px]">
                                EMAIL
                            </h2>
                            <a className="text-malibu-500 leading-relaxed whitespace-nowrap ml-[-40px] mr-[40px]">
                                lorenzolobrutto@gmail.com
                            </a>
                        </div>
                    </div>
                </div>
